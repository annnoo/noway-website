...
const config = {
  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        "accordion-down": "accordion-down 1.5s linear",
        "accordion-up": "accordion-up 1.5s linear",
        "collapsible-down": "accordion-down 0.2s linear",
        "collapsible-up": "accordion-up 0.2s linear",
      },
    },
  },
